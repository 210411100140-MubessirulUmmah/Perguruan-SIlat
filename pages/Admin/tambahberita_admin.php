...
<head>
    ...
    <style>
    .card {
    margin: 20px; /* Beri jarak dari tepi card */
    padding: 20px; /* Beri ruang di dalam card */
    }
    label {
        font-weight: bold; /* Beri teks label tebal */
    }
    input[type="text"],
    textarea {
        width: 100%; /* Isi seluruh lebar parent */
        padding: 8px; /* Beri ruang di dalam input dan textarea */
        margin-bottom: 10px; /* Beri jarak antar elemen */
    }
    select {
        width: 100%; /* Isi seluruh lebar parent */
        padding: 8px; /* Beri ruang di dalam select */
        margin-bottom: 10px; /* Beri jarak antar elemen */
    }
    input[type="file"] {
        margin-bottom: 10px; /* Beri jarak antar elemen */
    ...
    button[type="submit"] {
        ...
        padding: 10px 20px; /* Beri ruang di dalam tombol */
        ...
        border-radius: 5px; /* Tambah sudut melengkung pada tombol */
    }
    </style>
</head>
        ...
        <div class="content-wrapper" style="background-color: #BED2BE;">
            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 style="color: #000;margin-top:70px;"><b>Tambah Berita</b></h1>
                        </div>
                    </div>
                </div><!-- /.container-fluid -->
            </section>
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-12">
                            <!-- Default box -->
                            <div class="card">
                            <div class="top-section" style="background-color: #818992;color: #000;">
                            <!-- Konten bagian atas dengan latar belakang hitam -->
                            <h1 style="color: #000; background-color:#818992; text-align:center"><b> Form Tambah Berita</b></h1>
                            </div>
                                <div class="card-body">
