        ...
        <div class="content-wrapper" style="background-color: #BED2BE;">
            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 style="color: #000;margin-top:70px;"><b>Kotak Masuk</b></h1>
                        </div>
                    </div>
                </div><!-- /.container-fluid -->
            </section>
                                        ...
                                        <table class="table table-bordered table-striped" id="taBelinventaris" style="text-align: center;">
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    <tr>
                                                        <td><?php echo $no++ ?></td>
                                                        <td><?php echo $baris['nama_merchandise'] ?></td>
                                                        <td><?php echo $baris['deskripsi_merchandise'] ?></td>
                                                        <td><?php echo $baris['harga_merchandise'] ?></td>
                                                        <td><img src="../../dist/img/<?php echo $baris['foto_merchandise'] ?>" width="100" alt=""></td>
                                                    </tr>
                                                <?php }; ?>
                                            </tbody>
                                        </table>
