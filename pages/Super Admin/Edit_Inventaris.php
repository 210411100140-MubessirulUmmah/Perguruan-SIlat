...
$sql = "SELECT * FROM inventaris i WHERE id_inventaris = $id";
...
if (isset($_POST['simpan'])) {
    ...
    if ($namabarang && $jumlahbarang != '') {
        $query = "UPDATE inventaris SET nama_barang = '$namabarang', jumlah_barang = '$jumlahbarang' WHERE id_inventaris = $id";
                                    ...
                                    <div class="box-body">
                                        <form action="" method="post">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="nama_barang" id="nama_barang" value="<?php echo $data['nama_barang'] ?>" class="form-control" required oninvalid="this.setCustomValidity('Kolom Nama Barang Tidak Boleh Kosong')" oninput="setCustomValidity('')">
                                            </div>
                                            <div class="form-group">
                                                <label for="jumlah_barang">Jumlah Barang *</label>
                                                <input type="number" name="jumlah_barang" id="jumlah_barang" value="<?php echo $data['jumlah_barang'] ?>" class="form-control" required oninvalid="this.setCustomValidity('Kolom Jumlah Barang Tidak Boleh Kosong')" oninput="setCustomValidity('')">
                                            </div>
                                            <a href="Inventaris.php" class="btn bg-navy"><i class="fa fa-arrow-left"></i> Kembali</a>
                                            <button type="submit" name="simpan" class="btn bg-olive" onclick="return confirm('Apakah anda yakin ingin menambah ini ?')"><i class="fa fa-save"> Simpan</i></button>
                                        </form>
                                    </div>
                                </div>
