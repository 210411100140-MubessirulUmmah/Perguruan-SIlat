                        ...
                        <div class="col-12">
                            ...
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-md-8">
                                            <a href="tambahspp.php" class="btn btn-success">Tambah</a>
                                        </div>
                                        <div class="col-md-4">
                                                    ...
                                                    <?php foreach ($hasil as $baris) : ?>
                                                        <tr>
                                                            ...
                                                            <td class="action-icons">
                                                                ...
                                                                <a href="hapusspp.php?id=<?php echo $baris['id_pembayaran']; ?>" onClick="return confirm('Yakin?')" class="btn btn-danger btn-sm "><i class="bi bi-trash-fill"></i></a>
                                                                <a href="actionbayar.php?id=<?php echo $baris['id_pembayaran']; ?>" onClick="return confirm('Yakin?')" class="btn btn-sm btn-warning ">Bayar</a>
                                                            </td>
                                                            <?php $i++; ?>
                                                        <?php endforeach; ?>
                                                        </tr>
