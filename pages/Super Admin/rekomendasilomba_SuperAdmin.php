...
<head>
    ...
    <title>Super Admin | Rekomendasi Lomba</title>
...
<body class="hold-transition sidebar-mini layout-fixed">
        ...
        <div class="content-wrapper" style="background-color: #18191A;">
            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 style="color: #fff; margin-top: 70px;"><b>Rekomendasi Lomba</b>
                                <a href="tambahlomba.php" class="btn-link" style="padding: 0; text-decoration: none; color:white">
                                ...
                                <div class="card-body">
                                    <div class="container">
                                        <div class="row">
                                            <?php
                                            include '../koneksi.php';
                                            $daftar = mysqli_query($conn, "select * from rekomendasi_lomba");
    ...
    <script>
        $(document).ready(function() {
            $(".hapus-lomba").click(function(e) {
                e.preventDefault(); // Mencegah tindakan bawaan tombol

                var lomba_id = $(this).data('id');
                ...
                if (confirmation) {
                    ...
                    window.location.href = "hapusrekomendasilomba_SuperAdmin.php?id=" + lomba_id;
                }
            });
        });
    </script>
