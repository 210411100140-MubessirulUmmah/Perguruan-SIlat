...
<head>
    ...
    button {
        margin-top: 10px; /* Atur margin atas sesuai kebutuhan Anda */
    }
        </style>
</head>
...
<body>
    <div class="pembungkus">
        ...
        <div class="main-content">
            <h1 style="color: white; text-align:center">Daftar Pengajuan Lomba</h1>
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="container">
                                        ...
                                        <table border="1">
                                            ...
                                            $lomba = mysqli_query($koneksi, "SELECT * FROM pengajuan_lomba WHERE murid_id='$id'");
                                ...
                                <button type="submit" ><a href="pengajuanlomba_tanding.php" style="text-decoration: none; color:white">Ajukan Perlombaan</a> </button>    
                            </div>
