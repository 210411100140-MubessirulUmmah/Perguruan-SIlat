...
$tampil2 = mysqli_query($conn, $sql2);
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
    <div class="pembungkus">
        ...
        <div class="main-content" style="height:56rem;">
            <h1 style="color: white;">JADWAL LATIHAN</h1>

            <div class="container" style="width: 900px;height:500px;margin-left:-1rem;">
                <div id="calendar" style="background-color: black;padding-top:1rem;padding-right:1rem;padding-left:1rem;padding-bottom:1rem;width:950px;color:black;border-radius:3%;box-shadow: 0px 0px 9px rgb(255, 255, 255);">

                </div>

                <div id="eventModal2" class="modal fade" role="dialog" style="width: 25rem;margin-left:1rem;">
                    <div class="modal-dialog">
                        <div class="modal-content" style="height: 12rem;width:25rem;">
                            <div class="card text-white bg-secondary mb-3" style="width: 25rem;">
                                <div class="card-header ">
                                    <h5 class="card-title" id="Event_nama_latihan"></h5>
                                </div>
                                <div class="card-body">
                                    <ul class="list-group list-group-flush" style="width: 14rem;">
                                        <li class="list-group-item">
                                            <h6 class="card-title" id="Event_nama_pelatih"></h6>
                                        </li>
                                        <li class="list-group-item">
                                            <h6 class="card-title" id="Event_jenis_latihan"></h6>
                                        </li>
                                        <li class="list-group-item">
                                            <h6 class="card-title" id="Event_deskripsi_latihan"></h6>
                                        </li>
                                    </ul>
                                </div>
                                <div style="margin-left:14rem;margin-top:-13.3rem;padding-bottom:1rem;">
                                    <img src="silat.png" class="img-fluid rounded-start" alt="..." style="width:11rem;height:12.5rem;padding-top:1rem;">
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            $(document).ready(function() {
                var calendar = $('#calendar').fullCalendar({
                    ...
                    eventClick: function(event) {
                        ...
                        $('#Event_nama_latihan').text('Latihan ' + event.nama_latihan);
                        $('#Event_jenis_latihan').text('Jenis Latihan : ' + event.title.split('Latihan : ')[1].split('\n')[0].trim());
                        $('#Event_nama_pelatih').text('Nama Pelatih : ' + event.title.split('Pelatih : ')[1].split('\n')[0].trim());
                        $('#Event_deskripsi_latihan').text('deskripsi Latihan : ' + event.deskripsi_latihan);
                    }
