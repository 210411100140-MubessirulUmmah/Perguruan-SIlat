...
<body>
    <div class="pembungkus">
        ...
        <div class="main-content">
            <h1 style="color: white;">Form Pengajuan Lomba</h1>
                        ...
                        <div class="col-12">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="container">
                                        <div class="row">
                                        <form action="proses_pengajuanseni.php" method="post" enctype="multipart/form-data">
                                            <label for="id_murid">Id Murid:</label>
                                            <input type="text" id="id_murid" name="id_murid" value="<?php echo $user['id_aktor'] ?> ">
                                            ...
                                            <select id="nama_lomba" name="nama_lomba" required>
                                                ...
                                                // Tampilkan hasil query sebagai opsi dalam elemen select
                                            ...
                                            <label for="surat_ijin">Surat Izin Orang Tua (PDF):</label>
                                            <input type="file" id="surat_ijin" name="surat_ijin" accept=".pdf" required>

                                            <label for="surat_sehat">Surat Sehat (PDF):</label>
                                            <input type="file" id="surat_sehat" name="surat_sehat" accept=".pdf" required>
